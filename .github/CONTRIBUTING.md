# Contributing to MyDevil .htaccess Configs

♥ [MyDevil .htaccess Configs](https://github.com/rechandler12/htaccess-configs-mydevil) and
...
The [issue tracker](https://github.com/rechandler12/htaccess-configs-mydevil/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your
   ...
   git clone https://github.com/<your-username>/htaccess-configs-mydevil.git
   # Navigate to the newly cloned directory
   cd htaccess-configs-mydevil
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/rechandler12/htaccess-configs-mydevil
   ```
